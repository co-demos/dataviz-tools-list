...
# dataviz-tools-list
simple list of curated dataviz|ETL|apificaters tools

----

|open/proprio |NOM APPLICATIF |SCREENSHOT INTERFACE|usages |scrapping|ETL|dataviz|carto|API-fication|graphes|IA |utilisation |desk|saas|server|site web |documentation |AVANTAGES (hors pricing et open source) |INCONVENIENTS (hors pricing) |CLIENTS CIBLES |BESOINS |BEST FEATURES |MODELE ECO |NOTES COMMENTAIRES |PRIX / COÛT  | extra infos |
|:---:|:---:|:--------:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|---|---|---|---|---|---|---|---|---|---|
| open source |**Air Flow** |  ![airflow][airflow]     |dataviz + ETL | |X |X | | | | |desk |X | | |https://airflow.apache.org/ | | |- très tech | | | | | | | |
| open source |**API Platform** |  ![API_Platform][API_Platform]     |ETL + API-fication | |X | | |X | | |server | | |X |https://api-platform.com/ |https://api-platform.com/docs/ |- documentation extensive | | | | | | | | |
| open source |**ApiViz** |  ![apiviz][apiviz]     |dataviz + carto | | |X |X | | | |server + saas | |X |X |https://apiviz-preprod-sonum.netlify.com/ |https://co-demos.github.io/apiviz-frontend/ |- customisation de l'interface - design - CMS de dataviz |- version beta - stabilité - installation - formation nécessaire pour une bonne prise en main du backoffice |- collectivités - associations - administrations |déployer un site complet de dataviz rapidement |- carto - moteur de recherche - customization front |- abonnement SAAS pour hébergement | | | |
| propriétaire|**ArcGis** |  ![arcGis][arcGis]     |carto | | | |X | | | |desk + saas |X |X | |https://www.arcgis.com/index.html | | | | | | | |- plus d'outils GIS sur : https://georezo.net/wiki/main/logiciels/start | | |
| open source |**Bus Sémantique** |  ![bus_semantique][bus_semantique]     |ETL + API-fication | |X | | |X | | |saas + server | |X |X |https://www.virtual-assembly.org/semantic-bus/ |https://github.com/assemblee-virtuelle/Semantic-Bus |- fonctionne avec Transiscope - web sémantique |- UX compliquée - monolithique - formation nécessaire pour une bonne prise en main de l'applicatif |- associations |agréger / enrichir / ouvrir des données (API) |- APIfication - scrapping - geoloc |- paiement au flux | | | |
| propriétaire|**Captain Data** |[ pas encore trouvé de screenshot ] |ETL + scrapping |X |X | | | | | |saas | |X | |https://captaindata.co | | | | | | | | | | |
| propriétaire|**Carto** |  ![carto][carto]     |carto + dataviz | | |X |X | | | |saas | |X | |https://carto.com/ | | | | | | | |- plus d'outils GIS sur : https://georezo.net/wiki/main/logiciels/start | | |
| propriétaire|**Cloudera** |  ![cloudera][cloudera]     |ETL + IA | |X | | | | |X |saas | |X | |https://www.cloudera.com/ |https://www.cloudera.com/solutions/gallery.html |- UI UX clean |- monolithique | | | | | | | |
| propriétaire|**Crowd Flower** |  ![crowdflower][crowdflower]     |ETL + IA | |X | | | | |X |saas | |X | |https://www.figure-eight.com/ | |- UI UX clean |- monolithique | | | | | | | |
| open source |**CSVAPI** | [ pas encore trouvé de screenshot ] |API-fication | | | | |X | | |server | | |X |https://github.com/opendatateam/csvapi |https://github.com/opendatateam/csvapi |- API-fication de jeux de données simples |- limité à 1 csv par instance ? | | | | | | | |
| propriétaire|**Dash** | [ pas encore trouvé de screenshot ] |dataviz + carto | | |X |X | | | |saas | |X | |https://plot.ly/products/dash/ | | | | | | | | | | |
| propriétaire|**Data Rendez-vous** |  [ site down ] | | | | | | | | |saas | |X | |https://beta-public.datarendezvous.com | | | | | | | | | | |
| propriétaire|**Databricks** |  ![databricks][databricks]     |ETL + dataviz | |X |X | | | | |saas | |X | |https://databricks.com/product/unified-analytics-platform | |- UI UX clean |- monolithique | | | | | | | |
| open source |**DataFair (by Koumoul)** |  ![datafair][datafair]     |ETL + API-fication | |X | | |X | | |saas + server | |X |X |https://koumoul-dev.github.io/data-fair/ |https://koumoul-dev.github.io/data-fair/user-guide/introduction |- documentation - clean / fonctionne |- très proche de Solidata - ne permet pas d'agréger différents jeux autour d'un même schéma - hérite du schéma du fichier importé - pré-requis culture data importants pour l'utilisateur|- collectivités - associations - administrations | |- APIfication - Comptes utilisateurs - recettes / geoloc ...|- offre SaaS : hébergement de données - services : dev / instanciation|- AUTRES APPLIS DE DATAVIZ DEVELOPPÉES PAR KOUMOUL |https://koumoul.com/blog/datafair-opensource https://koumoul.com/| |
| propriétaire|**Dataiku** |  ![dataiku][dataiku]     |ETL + IA | |X | | | | |X |desk + saas |X |X | |https://www.dataiku.com/ |https://doc.dataiku.com/dss/latest/ |- UI UX clean |- outil d'ingénieur - monolithique | | | | | | | |
| open source|**DataWrapper** |       |dataviz | | | | | | | | saas |X |X | |https://www.datawrapper.de/ | |- UI UX clean |-  | | | | | | | |
| open source |**Dive** |  ![dive][dive]     |dataviz | | |X | | | | |server | | |X |https://dive.media.mit.edu/ |https://github.com/apache/incubator-airflow | | | | | | | | |https://www.alooma.com/blog/open-source-etl-tools-comparison|
| propriétaire|**Enigma** |  ![enigma][enigma]     |ETL + API-fication | |X | | |X | | |saas | |X | |https://www.enigma.com/ |https://vimeo.com/87900372 |- UI UX clean |- outil trop métier ? | | | | | | | |
| propriétaire|**Flourish** |  ![flourish][flourish]     |dataviz + carto | | |X |X | | | |saas | |X | |https://flourish.studio/examples/ | | | | | | | | | | |
| propriétaire|**Forepaas** |  ![forepaas][forepaas]     |ETL | |X | | | | | |saas | |X | |https://www.forepaas.com/fr/plate-forme/ | |- UI UX clean |- monolithique | | | | | | | |
| propriétaire|**GeoClip** |  ![geoclip][geoclip]     |carto + dataviz | | |X |X | | | |saas | |X | |https://www.geoclip.fr/ | | | | | | | |- plus d'outils GIS sur : https://georezo.net/wiki/main/logiciels/start | | |
| open source |**Gephi** |  ![gephi][gephi]     |dataviz graphes | | |X | | |X | |desk |X | | |https://gephi.org/ |https://gephi.org/users/ |- orienté graphes |- technicité - desk principalement | | | | | | | |
